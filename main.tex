...
Assignments come in two forms: a type-inferenced version similar to Go's \lstinline{:=} operator, and an explicitly-typed version similar to TypeScript's \lstinline{var}, \lstinline{const}, and \lstinline{let} operators.
